...
class EnhancedRecoveryGUI:
    ...
    def refresh_files_list(self, files):
        ...
        for idx, file in enumerate(files, 1):
            ...
            created_str = file.created.strftime('%Y-%m-%d %H:%M:%S') if hasattr(file, 'created') and file.created else "Unknown"
            ...
            if file.recovery_type in ['temp', 'hidden', 'backup']:
                display_date = "Not deleted yet"  # Show Creation Date for non-deleted files
            else:
